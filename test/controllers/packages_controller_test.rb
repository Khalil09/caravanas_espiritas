...
class PackagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create package" do
    assert_difference('Package.count') do
      post packages_url, params: { package: { description: @package.description, name: @package.name } }
    end
  ...
  test "should update package" do
    patch package_url(@package), params: { package: { description: @package.description, name: @package.name } }
