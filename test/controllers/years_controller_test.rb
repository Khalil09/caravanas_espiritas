...
class YearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create year" do
    assert_difference('Year.count') do
      post years_url, params: { year: { name: @year.name, package_id: @year.package_id, user_id: @year.user_id } }
    end
  ...
  test "should update year" do
    patch year_url(@year), params: { year: { name: @year.name, package_id: @year.package_id, user_id: @year.user_id } }
